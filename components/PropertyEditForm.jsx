...
function PropertyEditForm({property}) {
    ...
    async function handleUpdatePropertyById(formData){
        startTransition(()=>{
            updatePropertyById(formData)
        });
    }
    return (
      <form action={handleUpdatePropertyById}  className="text-black">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                className="border rounded w-full py-2 px-3 mb-2 placeholder:text-gray-400"
            ...
            <div className="mb-4 flex flex-wrap">
              <div className="w-full sm:w-1/3 pr-2">
                <label htmlFor="beds" className="block text-black font-bold mb-2"
                  >Beds</label>
                <input
                  type="number"
                  id="beds"
              ...
              <div className="w-full sm:w-1/3 px-2">
                <label htmlFor="baths" className="block text-black font-bold mb-2"
                  >Baths</label>
                <input
                  type="number"
                  id="baths"
            ...
            <div className="mb-4 bg-blue-50 p-4">
              <label className="block text-black font-bold mb-2">Rates (Leave blank if not applicable)</label>
              <div
            ...
            <div className="mb-4">
              <label
                ...
                className="block text-black font-bold mb-2">Seller Phone</label>
              <input
                type="tel"
                id="seller_phone"
