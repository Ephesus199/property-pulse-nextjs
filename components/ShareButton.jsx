'use client';
import { TelegramShareButton, FacebookShareButton,TwitterShareButton,WhatsappShareButton,EmailShareButton,TelegramIcon,FacebookIcon, TwitterIcon,WhatsappIcon,EmailIcon } from "react-share";
function ShareButton({property}) {
    ...
    return (
        ...
        <FacebookShareButton url={shareUrl} quote={property.name} hashtag={`#${property.type.replace(/\s/g, " ")}`}>
